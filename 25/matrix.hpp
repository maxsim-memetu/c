...
public:
	...
	row_type row_end(int n) {return row_begin(n) + cols();}
	...
	const_col_type col_end(int n) const {return col_begin(n) + cols();}
	...
	//the following 2 operator are different, one is used for assignment, the
	//other is for getting.
